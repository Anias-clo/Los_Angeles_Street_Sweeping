...
def get_sweep_data(prepared=False):
    ...
    if prepared == True:
        ...
        filename = './data/raw/parking-citations.csv'
    ...
    if os.path.exists(filename) and prepared == True:
        ...
        dataset = data.loc[(data['Issue Date'] >= '2017-01-01')&(data['Issue Date'] <= '2022-12-31')&(data['Violation Description'].str.contains('STREET CLEAN'))]
